...
<body class="internal">
  ...
  <div class="content-grid">
    <div class="info-block">
      <h2>A RESPOSTA É SIMPLES</h2>
      <p class="text-justify">
        O investimento no mercado digital se tornou uma necessidade frente ao e-commerce em todos os segmentos, mas principalmente em veículos automotivos e comerciais. De uma ideia simples mas com muita originalidade surge a Sale Motors cujo foco é analisar a ESTRATEGIA DIGITAL como um todo. A fragmentação de ferramentas sociais gera dificuldade de saber se estamos avançando no caminho certo com o melhor custo benefício.
      </p>
    </div>

    <div class="visual-element icon-wrapper">
      <img src="assets/images/conceito-de-branding-da-solucao-de-estrategia-de-gestao-corporativa.png" alt="Google Ads Logo" draggable="false" loading="lazy" />
    </div>
  ...
  <div class="content-grid">
    <div class="visual-element icon-wrapper">
      <img src="assets/images/pessoas-negocio-usando-internet.png" alt="Ícone de Lupa" class="feature-icon" draggable="false" loading="lazy" />
    </div>
    <div class="info-block">
      <p>
        Otimizando campanhas Google ADS, realizando analises no Google Analytics, buscando as melhores opções de pesquisa no Google Trends, Facebook e Instagram, obtemos os melhores resultados e integramos tudo.
      </p>
    </div>
  </div>
  ...
  <div class="content-grid">
    <div class="info-block">
      <p>
        Ficamos ao seu lado! Nossa equipe de analista fala diretamente com o cliente, prestando esclarecimentos, realizando alterações, explicando novidades por Whatsapp ou ligação.
        Esta curadoria torna sua operação mais dinâmica e assertiva, e o resultado destas mudanças é percebido rapidamente. Aumentando adequadamente a nutrição de Leads e conversão.
        Entre em contato, teremos prazer em esclarecer qualquer dúvida que você tenha.
      </p>
    </div>

    <div class="visual-element icon-wrapper">
      <img src="assets/images/conceito-de-negocio-com-equipe-de-perto.png" alt="Ícone de foguete" class="feature-icon" draggable="false" loading="lazy" />
    </div>
  </div>
