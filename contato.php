...
<noscript>
  <p class="aviso-js">Por favor, ative o JavaScript para uma melhor experiência de envio do formulário.</p>
</noscript>
...
<body>
        ...
        <ul data-menu="list" id="menu" class="menu-list">
          ...
          <li data-dropdown class="menu-no-hover">
            ...
            <ul class="menu-dropdown">
              <li><a href="#">Campanhas de Google</a></li>
              <li><a href="#">Campanhas de Meta</a></li>
              <li><a href="#">LinkedIn e TikTok</a></li>
  ...
  <ul class="custom-controls">
    <li><img src="assets/images/icones/campanhasdegoogle.png" alt=""></li>
    <li><img src="assets/images/icones/campanhasdemeta.png" alt=""></li>
    <li><img src="assets/images/icones/linkedinetiktok.png" alt=""></li>
    <li><img src="assets/images/icones/Monitoria.png" alt=""></li>
  </ul>
  ...
  <div class="sobre-nos-container">
    <div class="sobre-nos-text">
      ...
      <p>A Sale Motors é Google Partner Premier e especialista em tráfego pago para o setor automotivo. Com mais de 7 anos de experiência, otimizamos campanhas no Google Ads, Meta, LinkedIn e TikTok para aumentar sua visibilidade e conversões.</p>
      <p>Além disso, oferecemos monitoria contínua, garantindo mais leads, mais vendas e crescimento real!</p>
  ...
  <section class="faixa-google-partner">
    <div class="container-faixa-google">
      <a href="https://www.google.com/partners/agency?id=8905629692" target="_blank">
        <img src="./assets/images/icones/google-37.svg" alt="Logo do Google">
      </a>
      <div class="container-texto">
        <h3>Google Partner Premier</h3>
        <p>Somos uma das 3% das empresas mundiais certificadas pelo Google Partner Premier 2024, garantindo campanhas de alto desempenho, suporte especializado e resultados otimizados para o seu negócio.</p>
      </div>
    </div>
  </section>
  ...
  <div class="counter-section">
    <div class="counter-box">
      <div class="counter" data-target="7" data-format="default">+0</div>
      <div class="description">anos de experiência</div>
    </div>
    <div class="counter-box">
      <div class="counter" data-target="10000000" data-format="million">
        +0
      </div>
      <div class="description">de reais em anúncios</div>
    </div>
    <div class="counter-box">
      <div class="counter" data-target="100" data-format="default">+0</div>
  ...
  setTimeout(() => {
    ...
    if (msg) {
      ...
      setTimeout(() => msg.remove(), 500); // Remove do DOM após o fade
    }
  }, 5000); // 5 segundos
  </script>
